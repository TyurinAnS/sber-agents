...
- ✅ **Транскрибация голосовых сообщений** (Faster Whisper на GPU)
...
- **GPU с CUDA** (рекомендуется для транскрибации голосовых сообщений)
  - Опционально: можно использовать CPU, но будет медленнее
...
```
Пользователь: [голосовое сообщение: "купил продукты на полторы тысячи рублей"]
Бот: 🎤 Транскрибирую голосовое сообщение...
     [транскрибация занимает 1-2 секунды]
...
- Для транскрибации голосовых сообщений рекомендуется GPU (RTX 4090 или аналогичный)

## Документация

- **[docs/idea.md](docs/idea.md)** - описание идеи и основного функционала
- **[docs/vision.md](docs/vision.md)** - техническое видение и архитектура проекта
- **[docs/voice-transcription-research.md](docs/voice-transcription-research.md)** - исследование подходов к транскрибации (13+ вариантов)
- **[docs/voice-setup-guide.md](docs/voice-setup-guide.md)** - инструкция по настройке транскрибации голосовых сообщений
