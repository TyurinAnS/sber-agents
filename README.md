...
| М05 | `RAG с LangChain: от теории к практике` | Создание мультимодальных цепочек RAG | ✅ |
| М06 | `Мониторинг и оценка качества RAG-систем` | Метрики и инструменты для контроля качества | ✅ |
| М07 | `Advanced RAG` | Реализация банковского ассистента с RAG | ✅ |
| М08 | `Агенты с LangChain и LangGraph` | Теоретические основы построения агентов | 🔲 |
| М09 | `Model Context Protocol (MCP)` | Конструирование графов взаимодействий | 🔲 |
| М10 | `Безопасность агентных систем` | Интеграция с вспомогательными библиотеками | 🔲 |
| М11 | `Оценка качества агентов` | Практические аспекты безопасного deployment | 🔲 |
| М12 | `Мультиагентные системы` | Итоговый анализ и рефлексия | 🔲 |
